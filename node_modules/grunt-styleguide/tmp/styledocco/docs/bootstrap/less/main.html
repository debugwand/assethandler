<!DOCTYPE html><html><head><title>main | Style Guide
 ...
 <em> Copyright 2012 Twitter, Inc
 </em> Licensed under the Apache License v2.0
 <em> <a href="http://www.apache.org/licenses/LICENSE-2.0">http://www.apache.org/licenses/LICENSE-2.0</a>
 </em>
 * Designed and built with all the love in the world @twitter by @mdo and @fat.</p>
</div><div class="code"><pre><code>@import "components/mixins";
